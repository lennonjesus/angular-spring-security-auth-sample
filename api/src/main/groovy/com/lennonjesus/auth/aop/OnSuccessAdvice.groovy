package com.lennonjesus.auth.aop
...
class OnSuccessAdvice {
    ...
    public static
    final String ERRO_SEM_METODO_DEFINIDO = "\u00C9 necessário definir um RequestMethod.method() em sua annotation";

    @Resource
    MessageSource messageSource;

    @Around("execution(public * br.mp.mprj.medicamentos.api.**.*.*(..)) && @annotation(requestMapping)")
